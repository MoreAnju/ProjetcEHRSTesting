...
public class TestViewMedicalHistory {
...
WebDriver driver;
	...
	public void invokeBrowser()
		...
		try {
			...
			driver.findElement(By.xpath("//*[@id=\"root\"]/div/body/header/div/div[2]/div[2]/ul/li[3]")).click();
			//write test
...
public static void main(String args[])
	{
	TestViewMedicalHistory testobj =new TestViewMedicalHistory();
