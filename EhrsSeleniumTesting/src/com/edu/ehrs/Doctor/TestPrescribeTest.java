...
public class TestPrescribeTest {
...
WebDriver driver;
	...
	public void invokeBrowser()
		...
		try {
			...
			//click on prescribe test
			driver.findElement(By.xpath("//*[@id=\"root\"]/div/body/header/div/div[2]/div[2]/ul/li[2]")).click();
			//write test
			driver.findElement(By.name("testName")).sendKeys("Blood test");
			//submit 
			driver.findElement(By.xpath("//*[@id=\"root\"]/div/body/header/div/div[2]/div[3]/div/form/button")).click();
...
public static void main(String args[])
	{
	TestPrescribeTest testobj =new TestPrescribeTest();
